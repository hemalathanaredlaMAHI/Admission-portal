      ...
      <div class="row">
         <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
            <div class="page-caption half-half__inner">
               <h1><span class="page-title"> Download Call Letter
                  </span>
               </h1>
               <br>
               <br><br>
...
<div class="content">
   <div class="container">
      ...
      <td align='center'>
        ...
        <?php
          ...
          {?>
              ...
              <tr><td colspan="2">Download the following call letter documents.<br/><br/></td></tr>
              <tr>
              <td><a target="_blank" href = "<?php echo $filename ?>">1. Call Letter ( Application: <?php echo $appno; ?> )</a></td>
              <td><a target="_blank" href = "admissions/authentication/callletters/choiceoflearningcentre.pdf">2. Choice of Learning Centre</a></td>
              </tr>
              <tr>
              <td><a target="_blank" href = "admissions/authentication/callletters/CoursePassCertificate.pdf">3. Course Pass Certificate</a></td>
              <td><a target="_blank" href = "admissions/authentication/callletters/StudentDeclarationForm.pdf">4. Student Declaration Form</a></td>
              </tr>
              </table>
          ...
          {
            echo "<div style='color:red;font-weight:bold;'>".$flag."</div>";
          }
        ?>
        </div>
      </td>
      ...
      <br><br>
      <div id='display'>
      <form name="form1" method="post" action="downloadCallLetter.php">
      <font color='green'><b>
      Registered Email:&nbsp;&nbsp;&nbsp;
