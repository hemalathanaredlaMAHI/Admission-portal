...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
<a href="https://msitprogram.net/"><img src="logo.gif" />
	<!--	<center><title>MSIT ADMISSIONS <?php  echo YEARTEXT; ?></title></center>-->

		<link rel="icon" href="https://msitprogram.net/favicon.ico" type="image/x-icon" />
		<link rel="shortcut icon" href="https://msitprogram.net/favicon.ico" type="image/x-icon" />
									...
									<div id="user-profile-1" class="user-profile row">
										<div class="col-xs-12 col-sm-3 center">
											<div>
												...
												<span class="red" id="profileFullName">use jpg/jpeg format only</span>
										...
										<div class="col-xs-12 col-sm-9">
											<!--<div class="col-sm-3">
											<p>
												<a href="gatApplications.php" class="btn btn-round btn-primary btn-block">
												Apply for GAT
												</a>
											</p>
											</div>
											<div class="col-sm-3">
											<p>
												<a href="walkinApplications.php" class="btn btn-round btn-primary btn-block">
													Apply for Walkin
												</a>
											</p>
											</div>
											<div class="col-sm-3">
											<p>
												<a href="payment.php" class="btn btn-round btn-primary btn-block">
												My Payments
												</a>
											</p>
											</div> -->
											<?php
											if ($stmt = $mysqli->prepare("SELECT count(*) FROM userApplications where paymentStatus='no' and email = ?")) 
											{ 
												$stmt->bind_param('s', $_SESSION['email']); 
												$stmt->execute();
												$stmt->store_result();
												$stmt->bind_result($payNoAppcount); 
												$stmt->fetch();
												/*if($payNoAppcount!=0)
												{
													echo '<div class="col-sm-12 center">
															<h4 class="red">&nbsp;&nbsp;<i class="fa fa-hand-o-right red bigger-130"></i>
															You have applications with payment pending. Please pay now.</h4>
														</div>';
												}
												else
												{*/
													echo '<div class="col-sm-12 center">
															<h4 class="red">
															<b>Welcome to MSIT Admissions '.YEARTEXT.'</b></h4>
														</div>';
												//}
											}
											?>
											...
											<div class="profile-user-info profile-user-info-striped">
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														...
														&nbsp;&nbsp;&nbsp;
														<input style="width:150px" placeholder="Father Number" type="tel" name="landline" id="landline"  <?php if($landline_no!="") echo "value='".$landline_no."'"?> />
														</span>
														</span>
													</div>
												</div>
													...
													<div class="profile-info-value">
														...
														<label class="inline">
															...
															<select style="width:150px;" id="btechyear" name="btechyear">
																...
																<?php 
															for($yr=date('Y')-0;$yr>date('Y')-11;$yr--){
		...
		submitHandler: function (form) {
			...
			$.ajax(
			{
				...
				success:function(data, textStatus, jqXHR) 
				{
					...
					$('#addressText').show();
					$('#addressEdit').hide();
					$('#phoneText').html("Mobile-"+$('#mobile').val()+" Father-"+$('#landline').val());
							...
							on_error : function(error_type) {//on_error function will be called when the selected file has a problem
								...
								if(error_type == 1) {//file format error
									last_gritter = $.gritter.add({
										...
										text: 'Please choose a jpg|jpeg image!',
