								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											...
											<?php if(isset($_GET['statuskey'])) { ?>
											<form  class="form-horizontal" id="retype-form">
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Password: </label>
													<div class="col-sm-9">
														<span class="block input-icon input-icon-right">
															<input type="hidden" id="statuskey" name="statuskey" value=<?php echo $_GET['statuskey'];?> class="form-control" />
															<input type="password" id="password" name="password" placeholder="Reset-Password" class="form-control">
												...
												<div class="form-group">
													...
													<div class="col-sm-9">
														<span class="block input-icon input-icon-right">
															<input type="password" id="confirmPassword" name="confirmPassword" placeholder="Retype-Password" class="form-control">
															<i class="ace-icon fa fa-lock"></i>
														</span>
													</div>
												</div>
													...
													<div class="space"></div>
													<div class="clearfix">
														<span id="retype-loading" style="display:none;">
