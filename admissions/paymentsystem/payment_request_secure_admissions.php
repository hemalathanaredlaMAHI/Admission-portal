...
{	
	...
	header("Location:https://msitprogram.net/admissions/paymentAdmissions.php?errorMsg=Please try after some time.");
	//header("Location:../paymentAdmissions.php?errorMsg=Please try after some time 1.");
...
{	
	...
	header("Location:https://msitprogram.net/admissions/paymentAdmissions.php?errorMsg=Please try after some time.");
	//header("Location:../paymentAdmissions.php?errorMsg=Please try after some time 2.");
}
...
{	
	...
	header("Location:https://msitprogram.net/admissions/paymentAdmissions.php?errorMsg=Please try after some time.");
	//header("Location:../paymentAdmissions.php?errorMsg=Please try after some time 3.");
}
...
{	
	...
	header("Location:https://msitprogram.net/admissions/paymentAdmissions.php?errorMsg=Please try after some time.");
	//header("Location:../paymentAdmissions.php?errorMsg=Please try after some time 4.");
}
	
if ($stmt = $mysqli->prepare("SELECT count(*) as totaltrans from admissions_onlinetransactions WHERE email = ?")) { 
...
else
{
	...
	header("Location:https://msitprogram.net/admissions/paymentAdmissions.php?errorMsg=Please try after some time.");
	//header("Location:../paymentAdmissions.php?errorMsg=Please try after some time 5.");
}
...
else
{
	...
	header("Location:https://msitprogram.net/admissions/paymentAdmissions.php?errorMsg=Please try after some time.");
	//header("Location:../paymentAdmissions.php?errorMsg=Please try after some time 6.");
}
...
$params = $MerchantID.'|'.$trackidapp.'|NA|'.$amount.'|NA|NA|NA|INR|NA|'.$TypeField1.'|'.$SecurityID.'|NA|NA|F|'.$apl_name.'|'.$email.'|'.$mobile_no.'|'.$appno.'|'.$postedApp.'|NA|NA|https://msitprogram.net/admissions/paymentsystem/payment_response_admissions.php';
...
if ($insert_stmt = $mysqli->prepare("INSERT INTO admissions_onlinetransactions(
...
else
{
	...
	header("Location:https://msitprogram.net/admissions/paymentAdmissions.php?errorMsg=Please try after some time.");
	//header("Location:../paymentAdmissions.php?errorMsg=Please try after some time 7.");
}
...
<!-- <form name="bdpayment" method="post" action="testpayment.php"> -->
