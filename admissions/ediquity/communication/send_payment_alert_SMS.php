...
while($row = mysql_fetch_array($result))
  {
		...
		while($row1 = mysql_fetch_array($result1))
		{
		   $mobileno=$row1['mobile_no'];
			...
			curl_setopt($ch, CURLOPT_POSTFIELDS, "username=msitad&password=12838257&source=MSITAD&dmobile=".$mobileno."&message=Dear Applicant, Your payment is pending for MSIT Admissions 2014. Please pay as soon as possible ");
