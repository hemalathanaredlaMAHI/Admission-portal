					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
									<div class="col-xs-12">
										<form name="report_type" method="Get" action="communication/send_message.php">
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="phno">
															Phone Number <sup> <i class="icon-asterisk"></i> </sup>:
													</label>

													<div class="col-sm-9">
														<input class="input-large" type="text" id="phno" name="phno"/>
													</div>
												</div>
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="msg">
															Message <sup> <i class="icon-asterisk"></i> </sup>:
													</label>
