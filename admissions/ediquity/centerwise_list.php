	...
	<body>
		...
		<?php 
									...
									<div class="col-xs-12">
                                     ...
                                     $result = mysql_query("select * from ma_user_gat_exam_details m, ma_users mu where m.email=mu.email and m.test_center1=$center and mu.payment_status='yes'");
