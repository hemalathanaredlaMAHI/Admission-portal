...
<?php
    ...
    $cfg_dbuser = 'root';
    $cfg_dbpassword = '';
	$tbl_name='ma_payment_gateway_response';
									...
									<div class="col-xs-12">
										...
										<div class="table-responsive">
											<?php
												...
												$sql = "UPDATE $tbl_name
													   SET ResResult = 'RETURNED' 
													   WHERE ResTrackID = '$track'" ;
												$result=mysql_query($sql);
												
												// if successfully updated. 
												if($result){
												
												echo "<a href='multiple_transactions.php'>Successfully Updated</a>";
												}
