											...
											<form class="form-horizontal" id='searchForm'>
												<div class="space-2"></div>
													<div class="form-group">
															...
															<div class="col-sm-3">
																<div class="col-sm-12" align="center">PAYMENT STATUS <br/>
																<select class="form-control" name="emailstatus" id="emailstatus">
																	...
																	<option <?php if( isset($_GET['emailstatus']) && $_GET['emailstatus']=="YES" ) echo "selected"; ?> value="YES" selected>YES</option>
																</select></div>
															</div>
															<div class="col-sm-3">
...
<![endif]-->
		...
		<script type="text/javascript">
			function loadApps()
			{
				...
				var a = $("#onlyht").val();
				var url = "admissionPayments.php?emailstatus="+p+"&onlyht="+a;
			...
			jQuery(function($) {
				...
				<?php 
					$centerURL = "https://msitprogram.net/admissions/admin/service/getPayments_admissions.php?";
