...
<![endif]-->
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				bootbox.dialog({
						closeButton:false,
						message: "<span style='color:green;font-weight:bold;' align='center'><?php echo $_GET['message']; ?></span>", 
						buttons: {
							"success" : {
								"label" : "OK",
				...
				<?php 
					$centerURL = "https://msitprogram.net/admissions/admin/service/walkinApps.php";
				?>
									...
									{ "mData": null,
									 "mRender":function(data, type, full){
										 if(full.slotdate==null || full.slotdate=="")
											   ...
											   return "<a href='generateWalkinHT.php?appno="+full.walkinAppNo+"'>Send HallTicket</a><br/><a target='_blank' href='viewWalkinHT.php?appno="+full.walkinAppNo+"'>Generate HallTicket</a>";
										}
									}
								],
					//"aaSorting": [],
