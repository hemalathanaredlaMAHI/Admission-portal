...
if($post)
{
	...
	if ($insert_stmt = $mysqli->prepare("update ".prefix."ma_user_education_details set name_of_exam_tenth =?, year_of_passing_tenth=?, education_institute_tenth=?, board_of_tenth=?, overall_percentage_tenth=?, division_of_tenth=? where email = ? ")) {   			
	...
	if ($insert_stmt = $mysqli->prepare("update ".prefix."ma_user_education_details set name_of_exam_inter =?, year_of_passing_inter=?, education_institute_inter=?, board_of_inter=?, overall_percentage_inter=?, division_of_inter=? where email = ? ")) {   			
	...
	if ($insert_stmt = $mysqli->prepare("update ".prefix."ma_user_education_details set name_of_exam_graduation =?, year_of_passing_graduation=?, education_institute_graduation=?, university_of_graduation=?, overall_percentage_graduation=?, division_of_graduation=? where email = ? ")) {   			
	...
	else
	{
		...
		if ($insert_stmt = $mysqli->prepare("update ".prefix."ma_user_education_details set name_of_exam_postgraduation =?, year_of_passing_postgraduation=?, education_institute_postgraduation=?, university_of_postgraduation=?, overall_percentage_postgraduation=?, division_of_postgraduation=? where email = ? ")) {   			
	...
	if($_SESSION['educationdetails_status'] !="yes")
	{
		...
		if ($insert_stmt = $mysqli->prepare("update ".prefix."ma_users set educationdetails_status = ? where email = ? ")) {   			
