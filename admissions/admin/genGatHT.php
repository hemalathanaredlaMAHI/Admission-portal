								...
								<div class="widget-body">
									<div class="widget-main">	
										...
										<div class="col-sm-12" align="center">
											<div class="col-sm-3">
												<a class="pull-right btn btn-sm btn-success" href='../authentication/halltickets/At home' target='_blank'>
													<span class="bigger-110">&nbsp;&nbsp;At home&nbsp;&nbsp;</span>
												</a><br/><br/><br/>
											</div>
											<div class="col-sm-3">
...
if ($result = $mysqli->query($qry)) 
{
	...
	while($row = $result->fetch_object()) 
	{
		...
		$pdf->SetSubject("Halltickets ".YEARTEXT);
		$pdf->AddPage();	
		...
		$pdf->Cell('','3','');
		$pdf->SetXY(45,44);
		$pdf->Cell('','','Entrance Test '.YEARTEXT,'','','C');			
		...
		/*$ch1 = curl_init('http://www.cbexams.com/genbarcode/GenBarCode.aspx?msg=".$appno."&disptext=y');
            //curl_setopt($ch1, CURLOPT_, 1);
            //curl_setopt($ch1, CURLOPT_GETFIELDS, "msg=".$appno."&disptext=y");
            curl_setopt($ch1, CURLOPT_RETURNTRANSFER,1);
            $data = curl_exec($ch1);
            curl_close($ch1);
*/
		//$barcode = "http://www.cbexams.com/genbarcode/GenBarCode.aspx?msg=".$appno."&disptext=y";
        $barcode = "http://www.cbexams.com/genbarcode/GenBarCode.aspx?msg=".$appno."&disptext=y";

		$pdf->Image($barcode,'40','95','50','15','JPEG');
		...
		if($testcenter=='At home')
		{
			$pdf->SetFont('times','B',10);
			$pdf->SetXY(32,132);
			$pdf->Cell('20','','Your Home,');
			$pdf->SetXY(32,137);
			$pdf->Cell('20','','.............................,');	
			$pdf->SetXY(32,142);
			$pdf->Cell('20','','..............................');	
		...
		if($testcenter=='Hyderabad')
		{
			...
			$pdf->SetXY(32,137);
			$pdf->Cell('20','','(LIB Block New Building) Shaikpet,');	
			$pdf->SetXY(32,142);
			$pdf->Cell('20','','Mehdipatnam(Hi-Tech City Road), Hyderabad-500008');	
			$pdf->SetXY(32,148);
		...
		if($testcenter=='Kakinada')
		{
			...
			$pdf->SetXY(32,152);
			$pdf->Cell('20','','Phone: +91 7799834586');
		}		 
		if($testcenter=='Tirupati')
		{
			$pdf->SetFont('times','B',10);
			$pdf->SetXY(32,132);
			$pdf->Cell('20','','SS Digital Zone, Chandragiri Road,');
			$pdf->SetXY(32,137);
			$pdf->Cell('20','','Beside Hero Showroom, Perur , Tirupati-517505.(A.P)');
			$pdf->SetXY(32,147);
			$pdf->Cell('20','','Contact: Sai Kumar Pindi');	
			$pdf->SetXY(32,152);
			$pdf->Cell('20','','Phone: +91 8238099194');
		}		 
		if($testcenter=='Vijayawda')
		{
			$pdf->SetFont('times','B',10);
			$pdf->SetXY(32,132);
			$pdf->Cell('20','','Potti Sriramulu Chalavadi Mallikarjuna Rao');
			$pdf->SetXY(32,137);
			$pdf->Cell('20','','College of Engineering & Technology, Raghava Reddy Street,');
			$pdf->SetXY(32,142);
			$pdf->Cell('20','','Kothapet, Vijayawada-520001. Andhra Pradesh');
			$pdf->SetXY(32,148);
			$pdf->Cell('20','','Contact: Prof KBS Sastry(HOD CS)');	
			$pdf->SetXY(32,153);
			$pdf->Cell('20','','Cell:+919849670540 Ph: 0866-2476082 / 2476964 ');
		}
		if($testcenter=='Warangal')
		{
			...
			$pdf->SetXY(32,142);
			$pdf->Cell('20','','Hasanparthy Mandal, Warangal-506015(T.S)');
			$pdf->SetXY(32,147);
		...
		if($testcenter=='Visakhapatnam')
		{
			$pdf->SetFont('times','B',10);
			$pdf->SetXY(32,132);
			$pdf->Cell('20','','Pydah College of Engineering & Technology ,');
			$pdf->SetXY(32,137);
			$pdf->Cell('20','',' Gambheeram Village, Anandapuram Mandal,');
			$pdf->SetXY(32,142);
			$pdf->Cell('20','','Visakhapatnam -531163. Andhra Pradesh');
			$pdf->SetXY(32,147);
			$pdf->Cell('20','','Contact: Dr.Sarabandi +91 9848193003');	
			$pdf->SetXY(32,152);
			$pdf->Cell('20','','	          : Reddy  +919966332502');
		}
		$pdf->SetXY(158,140);
