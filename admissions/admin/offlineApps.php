...
<![endif]-->
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				<?php 
					$centerURL = "https://msitprogram.net/admissions/admin/service/offlineApps.php";
				?>
					...
					"aoColumns": [
									...
									{ "mData": null,
									 "mRender":function(data, type, full){
											var message = "Your application has been accepted for GAT entrance test. Your application no is "+full.gatAppNo
											return "<a href='sendSMS.php?mobnumber="+full.mobile_no+"&message="+message+"'>Send SMS</a>";
										}
									}
								],
					//"aaSorting": [],
