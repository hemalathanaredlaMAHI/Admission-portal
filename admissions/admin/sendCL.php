													...
													<div class="form-group">
															...
															<div class="col-sm-3">
																...
																<a class="pull-right btn btn-sm btn-success" onclick='loadsendApps()'>
																	<span class="bigger-110">SEND Call Letters</span>
																</a>
															</div>
...
<![endif]-->
		...
		<script type="text/javascript">
			function loadApps()
			{
				...
				var a = $("#onlyht").val();
				var url = "sendCL.php?emailstatus="+p+"&onlyht="+a;
			...
			jQuery(function($) {
				...
				<?php 
					$centerURL = "https://msitprogram.net/admissions/admin/service/gatcl.php?";
