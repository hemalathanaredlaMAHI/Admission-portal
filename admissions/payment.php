				...
				<div class="main-content-inner">
					...
					<div class="tabbable" id="paymentPageTab">
						<ul class="nav nav-tabs padding-12 tab-color-blue background-blue" id="myTab4">
							<li id="myPaymentsli">
								<a data-toggle="tab" href="#myPayments">My Payments</a>
							</li>
							<li id="payOnlineli">
								<a data-toggle="tab" href="#payOnline">Pay Online</a>
							</li>
							<!-- <li id="payDDli">
						...
						<div class="tab-content">
							<div id="myPayments" class="tab-pane">
							</div>
							<div id="payOnline" class="tab-pane">
							</div>
							<div id="payDD" class="tab-pane">
		...
		<?php } else { ?>
			<form class="form-horizontal" id="dd-payment-form">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input class="input-large" type="text" id="amount" name="amount" value="1000.00" placeholder="1000.00" readonly />
					</div>
				</div>
				<!-- change by Ranjith -->
...
{
	$(".loader").fadeOut("slow");
	var loadActiveTab = "#myPayments";
	if(window.location.hash != "") {
		loadActiveTab = window.location.hash;
	}
	if(loadActiveTab!="#payDD")
	{
    ...
    $('#myTab4 a').click(function (e) {
		...
		if(tabID=="payOnline")
			$("#" + tabID).load("payOnlineTab.php")
		if(tabID=="myPayments")
			$("#" + tabID).load("myPaymentsTab.php")
    });
