								...
								<div id="signup-box" class="signup-box visible widget-box no-border">
									<div class="widget-body">
										...
										<h4 class="header green lighter bigger">
											<a href="https://msitprogram.net/"><img src="logo.gif" /></a>
								...
								<?php
										...
										//New code added ends
											...
											<form class="form-horizontal" id="registration-form"> 
												...
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="board"> <!--  Board & Serial Number: --> 
														Contact No:
													</label>
													<div class="col-sm-9">
														<span class="block input-icon input-icon-right">
															<!-- Update By Ranjith on Marc18, 2019  -->
															...
															<input style="width:38%" title="Your Contact No" type="text" id="serialno" name="serialno" placeholder="Contact No" />
															<!--Renuka Edited--
															&nbsp;Btech Branch
															<input style="width:38%" title="Btech Branch" type="text" id="btech_branch" name="serialno" placeholder="Btech Branch" /> &nbsp;&nbsp;&nbsp;
														-->
														</span>
													</div>
												</div>
							...
							//If GAT applications date expires
								...
								?>
									...
									<div class="form-group">
										...
										<h4 class="header red bigger"> Registration process completed for Admissions <?php echo YEARTEXT; ?> </h4>
