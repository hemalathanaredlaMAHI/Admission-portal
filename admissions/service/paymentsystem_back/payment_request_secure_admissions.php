...
{	
	...
	header("Location:http://msitprogram.net/admissions/paymentAdmissions.php?errorMsg=Please try after some time.");
...
$params = $MerchantID.'|'.$trackidapp.'|NA|'.$amount.'|NA|NA|NA|INR|NA|'.$TypeField1.'|'.$SecurityID.'|NA|NA|F|'.$apl_name.'|'.$email.'|'.$mobile_no.'|'.$appno.'|'.$postedApp.'|NA|NA|http://msitprogram.net/admissions/paymentsystem/payment_response_admissions.php';
